...
* [Mobile Core](mobile-core/README.md)
  * [Release Notes](mobile-core/mobile-core-release-notes.md)
  * [Mobile Core API reference](mobile-core/mobile-core-api-reference.md)
  * [Mobile Core event reference](mobile-core/mobile-core-event-reference.md)
  * [Configuration](mobile-core/configuration/README.md)
    * [Configuration API reference](mobile-core/configuration/configuration-api-reference.md)
    * [Configuration event reference](mobile-core/configuration/configuration-event-reference.md)
  * [Identity](mobile-core/identity/README.md)
    * [Identity API reference](mobile-core/identity/identity-api-reference.md)
    * [Identity event reference](mobile-core/identity/identity-event-reference.md)
  * [Lifecycle](mobile-core/lifecycle/README.md)
    * [Lifecycle extension in Android](mobile-core/lifecycle/lifecycle-extension-in-android.md)
    * [Lifecycle extension in iOS](mobile-core/lifecycle/lifecycle-extension-in-ios.md)
    * [Lifecycle API reference](mobile-core/lifecycle/lifecycle-api-reference.md)
    * [Lifecycle event reference](mobile-core/lifecycle/lifecycle-event-reference.md)
    * [Lifecycle metrics](mobile-core/lifecycle/lifecycle-metrics.md)
    * [Configuration keys](mobile-core/lifecycle/configuration-keys.md)
  * [Signal](mobile-core/signals/README.md)
    * [Signal API reference](mobile-core/signals/signal-api-reference.md)
    * [Signal event reference](mobile-core/signals/signal-event-reference.md)
  * [Rules Engine](mobile-core/rules-engine/README.md)
    * [Rules Engine technical details](mobile-core/rules-engine/rules-engine-details.md)
    * [Rules Engine consequence details](mobile-core/rules-engine/rules-engine-consequence-details.md)
  * [Platform Services](mobile-core/platform-services.md)
* [Adobe Experience Platform Edge Network](experience-platform-extension/README.md)
  * [Release Notes](experience-platform-extension/release-notes.md)
  * [Edge Network API reference](experience-platform-extension/edge-network-api-reference.md)
...
* [Consent for Edge Network](consent-for-edge-network/README.md)
  * [Release Notes](consent-for-edge-network/release-notes-1.md)
  * [API Reference](consent-for-edge-network/api-reference.md)
* [Identity for Edge Network](identity-for-edge-network/README.md)
  * [Release Notes](identity-for-edge-network/release-notes-1.md)
  * [API Reference](identity-for-edge-network/api-reference.md)
...
* [Profile](profile/README.md)
  ...
  * [Profiles event reference](profile/profiles-event-reference.md)
