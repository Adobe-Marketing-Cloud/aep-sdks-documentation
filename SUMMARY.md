...
* [Mobile Core](using-mobile-extensions/mobile-core/README.md)
  ...
  * [Signal](using-mobile-extensions/mobile-core/signals/README.md)
    * [Signal API reference](using-mobile-extensions/signals/signal-api-reference.md)
    * [Signal event reference](using-mobile-extensions/signals/signal-event-reference.md)
