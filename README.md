...
To implement the SDK, create a mobile property in Adobe Experience Platform Launch, set up the configuration that is required by the Mobile Core extension, and other extensions you want to add, and publish the configuration into an environment. To initialize the SDK in your app, reference the environment to get started.
