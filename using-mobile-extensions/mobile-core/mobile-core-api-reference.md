...
{% hint style="warning" %}
This API is only handled by the [Edge](https://aep-sdks.gitbook.io/docs/v/AEP-Edge-Docs/using-mobile-extensions/adobe-edge) and [Edge Identity](https://aep-sdks.gitbook.io/docs/v/AEP-Edge-Docs/using-mobile-extensions/adobe-edge-identity) extensions. Calling `resetIdentities` does not clear identities in non-edge extensions, such as [Identity](https://aep-sdks.gitbook.io/docs/v/AEP-Edge-Docs/using-mobile-extensions/mobile-core/identity).
{% endhint %}
