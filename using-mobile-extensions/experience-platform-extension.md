...
3. Type in the extension settings
   1. For more information, see [Configure datastreams](../getting-started/configure-datastreams.md) and [datastreams](experience-platform-extension.md#datastreams).
4. Click **Save**.
