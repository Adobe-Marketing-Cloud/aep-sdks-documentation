...
### Analytics Content Request {#analytics-content-request}
...
#### Event Data Example {#event-data-example}
...
### Analytics Request Identity {#analytics-request-identity}
...
#### Data Payload Definition {#data-payload-definition-1}

No key is required for the Analytics request event.

#### Event Details {#event-details-1}

| **Event Type** | **Event Source** | **Paired** |
| :--- | :--- | :--- |
| com.adobe.eventType.analytics | com.adobe.eventSource.requestIdentity | Yes |

### Configuration Response Content {#configuration-response-content}
...
#### Data Payload Definition {#data-payload-definition-2}
...
### Acquisition Referrer Information Response {#acquistion-referrer-information-response}
...
#### Data Payload Definition {#data-payload-definition-3}
...
#### Sample Event Payload {#sample-event-payload}
...
#### Event Details {#event-details-3}

| **Event Type** | **Event Source** | **Paired** |
| :--- | :--- | :--- |
| com.adobe.eventType.lifecycle | com.adobe.eventSource.requestContent | No |

#### Data Payload Definition {#data-payload-definition-4}
...
#### Event Details {#event-details-4}

| **Event Type** | **Event Source** | **Paired** |
| :--- | :--- | :--- |
| com.adobe.eventType.lifecycle | com.adobe.eventSource.responseContent | No |

#### Data Payload Definition {#data-payload-definition-5}
