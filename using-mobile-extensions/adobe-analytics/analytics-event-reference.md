...
This event is a request to complete processing on the Analytics hits queue. The event will be created when either of the [`trackAction`](../../foundation-extensions/mobile-core/mobile-core-api-reference#trackaction) or [`trackState`](../../foundation-extensions/mobile-core/mobile-core-api-reference#trackstate) APIs is called.
...
* [sendQueuedHits](analytics-api-reference#sendqueuedhits) 
* [clearQueue](analytics-api-reference#clearqueue)
* [getQueueSize](analytics-api-reference#getqueuesize)
...
The Analytics request identity event is responsible for fetching the Analytics tracking identifier \(AID\) and custom visitor identifier \(VID\) from the Analytics extension and is generated in the Analytics [getTrackingIdentifier](analytics-api-reference#gettrackingidentifier) and [getCustomVisitorIdentifier](analytics-api-reference#get-the-custom-visitor-identifier) calls.
...
* If AID and VID is set, dispatches an Analytics Identity Response Event with the AID and VID value.
