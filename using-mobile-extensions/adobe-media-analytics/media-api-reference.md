...
| `info` | For AdBreakStart, AdBreak information created using [Create AdBreak Object](media-api-reference.md#create-adbreak-object).  For AdStart, Ad information created using [Create Ad Object](media-api-reference.md#create-ad-object).  For ChapterStart, Chapter information created using [Create Chapter Object](media-api-reference.md#create-chapter-object).  Not required for other events. |
