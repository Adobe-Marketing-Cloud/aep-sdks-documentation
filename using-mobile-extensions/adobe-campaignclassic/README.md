...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">Specifies the amount of time to wait for a response from the Adobe Campaign Classic registration or tracking server.
      </td>
    </tr>
    <tr>
...
<tr>
      ...
      <td style="text-align:left">No</td>
      <td style="text-align:left">Sets the development environment Android mobile app integration key which links the app to a specific Android application campaign on Adobe Campaign Classic.
      </td>
    </tr>
<tr>
