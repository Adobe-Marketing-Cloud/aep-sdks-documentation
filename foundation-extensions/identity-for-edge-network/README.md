...
Process:
1. Removes the ad ID from the client side XDM `IdentityMap`, which is removed from subsequent [XDM Experience events](../experience-platform-extension/xdm-experience-events.md).
