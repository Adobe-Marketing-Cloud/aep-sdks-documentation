...
This is a destructive action, since once an ECID is removed it cannot be resued. The new ECID generated by this API can impact metrics like unique visitors and cause duplication of user profiles and device profiles.
