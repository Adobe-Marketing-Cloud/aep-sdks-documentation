...
This is a destructive action. Once an ECID is removed it cannot be reused. The new ECID generated by this API can impact metrics like unique visitors and cause duplication of user profiles and device profiles. To remove existing custom identifiers, use [`removeIdentity`](#removeidentity).
