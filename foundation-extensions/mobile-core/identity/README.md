...
To append visitor information to the URL that is being used to open the web view, call [appendToUrl](identity-api-reference.md#appendToUrl-2):
...
To append visitor information to the URL that is being used to open the web view, call [appendVisitorInfoForUrl](identity-api-reference.md#appendToUrl-js):
...
Alternately, starting with SDK version 1.0.5, you can call [getUrlVariables](identity-api-reference.md#geturlvariables-js) and build your own URL:
...
To append visitor information to the URL that is being used to open the web view, call [appendVisitorInfoForUrl](identity-api-reference.md#appendvisitorinfoforurl-4):
...
Alternately, you can call [getUrlVariables](identity-api-reference.md#geturlvariables-5) and build your own URL:
...
To append visitor information to the URL that is being used to open the web view, call [AppendToUrl](identity-api-reference.md#appendvisitorinfoforurl-4):
