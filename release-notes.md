...
**Android Core 1.4.4 \(Core version 1.4.5\)**
...
**Android Identity 1.1.1 \(Core version 1.4.4\)**
...
**iOS Places Monitor 1.0.0** \(Places\)
...
The first version of **Adobe Places** is now available for public beta access!
